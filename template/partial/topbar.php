            ...
            <ul class="nav-menus">
                <li class="language-nav">
                    <div class="translate_wrapper">
                        <div class="current_lang">
                            <div class="lang"><i class="flag-icon flag-icon-pe"></i><span class="lang-txt">PE </span></div>
                        </div>
                ...
                <li class="onhover-dropdown">
                    ...
                    <div class="onhover-show-div notification-dropdown">
                        ...
                        <ul>
                            <li class="b-l-primary border-10">
                ...
                <li class="profile-nav onhover-dropdown pe-0 py-0">
                    <div class="media profile-media">
                        <!-- Avatar opcional -->
                        <!-- <img class="b-r-10" src="assets/images/dashboard/profile.png" alt="Foto de perfil"> -->

                        <button class="b-r-10 media-body user-info d-flex align-items-center gap-2 w-100 text-start bg-transparent border-0 p-0"
                            type="button"
                            aria-haspopup="true"
                            aria-expanded="false">
                            <div class="flex-grow-1">
                                <span class="d-block fw-600">
                                    <?= htmlspecialchars($_SESSION['nombres_apellidos_usuario'] ?? 'Usuario', ENT_QUOTES, 'UTF-8') ?>
                                </span>
                                <p class="mb-0 font-roboto">
                                    <?= htmlspecialchars($_SESSION['nombre_rol'] ?? 'Rol', ENT_QUOTES, 'UTF-8') ?>
                                </p>
                                <p class="mb-0 font-roboto text-muted">
                                    <?= htmlspecialchars($_SESSION['nombre_sede'] ?? 'Sede', ENT_QUOTES, 'UTF-8') ?>
                                </p>
                            </div>
                            <i data-feather="chevron-down" class="middle"></i>
                            <span class="visually-hidden">Abrir menú de perfil</span>
                        </button>
                    </div>

                    <ul class="profile-dropdown onhover-show-div">
                        <li><a href="#"><i data-feather="user"></i><span>Mi cuenta</span></a></li>
                        <li><a href="#"><i data-feather="mail"></i><span>Bandeja</span></a></li>
                        <li><a href="#"><i data-feather="check-square"></i><span>Tareas</span></a></li>
                        <li><a href="#"><i data-feather="settings"></i><span>Configuración</span></a></li>
                        <li><a href="logout.php"><i data-feather="log-out"></i><span>Cerrar sesión</span></a></li>
                    </ul>
                </li>
            </ul>
        </div>
